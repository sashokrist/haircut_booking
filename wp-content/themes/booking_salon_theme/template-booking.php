					...
					<div class="card-body">
						<form id="booking-form" method="post" action="">
							...
							<div class="mb-4">
								...
								<div class="mb-3">
									<label for="customer_email" class="form-label">Имейл *</label>
							...
							<!-- Employee Selection -->
							<div class="mb-4">
								<h3>Избери фризьор</h3>
								<div class="mb-3">
									<label for="employee" class="form-label">Фризьор *</label>
							...
							<div class="mb-4">
								...
								<div class="mb-3">
									<label for="booking_time" class="form-label">Час *</label>
							...
							<!-- Additional Notes -->
							<div class="mb-4">
								<label for="notes" class="form-label">Специални заявки или бележкаs</label>
								<textarea class="form-control" id="notes" name="notes" rows="3"></textarea>
							</div>

							<!-- Submit Button -->
							<div class="text-center">
								<button type="submit" name="submit_booking" class="btn btn-primary btn-lg">Запази час</button>
							</div>
						</form>
					</div>
				</div>
